...
FROM T_E_ACTION_PUBLICITAIRE_ACT ACT
	...
	JOIN T_E_SECTEUR_ACTIVITE_SEC SEC on SEC.NUMERO_SECTEUR_ACTIVITE = ACT.NUMERO_SECTEUR_ACTIVITE
	...
	JOIN T_J_PRODUIT_ACTIon_PAC PAC on PAC.NUMERO_SECTEUR_ACTIVITE = ACT.NUMERO_SECTEUR_ACTIVITE
...
SELECT FOU.NUMERO_FOURNISSEUR, ENS.NUMERO_ENSEIGNE, RUE||' '||VILLE||' '||CP as Adresse, GRO.NOM_GROUPE, FOU.NOM_FOURNISSEUR, FOU.PRENOM_FOURNISSEUR, FOU.TELEPHONE_FOURNISSEUR, FOU.MAIL_FOURNISSEUR, BUD.OBJECTIF, BUD.ENGAGE, BUD.FACTURE
