...
FROM T_E_PRESTATAIRE_INTERNE_INT INT
	Join T_E_PRESTATAIRE_PRE PRE on PRE.NUMERO_PRESTATAIRE = IMA.NUMERO_PRESTATAIRE
	Join T_J_PRESTATAIRE_INTERNE_SYSTEME_PIS PIS ON PIS.NUMERO_PRESTATAIRE = INT.NUMERO_PRESTATAIRE
	Join T_J_LOGICIEL_INTERNE_PRESTATAIRE_PIS PIL ON PIL.NUMERO_PRESTATAIRE = INT.NUMERO_PRESTATAIRE
