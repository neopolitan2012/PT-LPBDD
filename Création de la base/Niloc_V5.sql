...
(
   ...
   LIBELLE_QUALITE_TECHNIQUE VARCHAR(50),
...
(
   NUMERO_SPECIALITE    INTEGER              not null,
   LIBELLE_SPECIALITE   VARCHAR2(256),
...
(
   NUMERO_TYPE_MACHINE  INTEGER              not null,
   LIBELLE_TYPE_MACHINE VARCHAR2(256),
...
alter table T_R_SYSTEME_SYS
    add constraint UQ_T_R_SYSTEME_SYS_LIBELLE_SYSTEME unique (LIBELLE_SYSTEME);

alter table T_R_SPECIALITE_SPE
    add constraint UQ_T_R_SPECIALITE_SPE_LIBELLE_SPECIALITE unique (LIBELLE_SPECIALITE);

alter table T_R_TYPE_MACHINE_TYM
    add constraint UQ_T_R_TYPE_MACHINE_TYM_LIBELLE_TYPE_MACHINE unique (LIBELLE_TYPE_MACHINE);
